...
// borderRadius in webkit will expand, so we disable it.
...
// alert is keywords, dont' use it as var name!!!!
var bs_alert = {
  '.alert': {
...
var obj = objutil.merge({$vars:$vars, $mixins:$mixins}, scaffolding, bs_alert)

var result = lessobj(obj)

log(css(result), 'file:./lessobj-bootstrap.css')
